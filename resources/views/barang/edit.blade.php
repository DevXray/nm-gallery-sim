        ...
        <div class="form-sect">
            <div class="fgrid">
                <div class="field f-full">
                    ...
                    <input type="text" name="nama_barang" class="finput" required value="{{ old('nama_barang', $barang->nama_barang) }}">
                </div>
                <div class="field">
                    <label class="flbl">Harga Sewa / Hari *</label>
                    <input type="number" name="harga_sewa" class="finput" required value="{{ old('harga_sewa', $barang->harga_sewa) }}">
                </div>
                <div class="field">
